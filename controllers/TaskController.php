  ...
  public function deleteTask()
{
    ...
    public function update()
    {
        ...
        $stmt = $conn->prepare("UPDATE task SET title = ?, description = ?, due_date = ?, priority = ?, completed = ? WHERE id = ?");
        $stmt->bind_param("ssssii", $title, $description, $due_date, $priority, $completed, $id);
